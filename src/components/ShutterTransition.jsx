          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
            <div className="relative w-full text-center flex flex-col items-center justify-center">
              <img
                src="/logo_white.png"
                alt="Zunuz Logo"
                className={`w-[60vw] max-w-[220px] h-auto object-contain drop-shadow-[0_20px_45px_rgba(0,0,0,0.98)] transition-all duration-[750ms] cubic-bezier(0.16, 1, 0.3, 1) will-change-transform ${showZunuzText ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-16 scale-95"}`}
              />
              <p
