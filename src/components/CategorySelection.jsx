        ...
        {wp.map((D) => (
          ...
          >
            ...
            <div className="relative z-10 text-center px-4 flex flex-col items-center select-none transition-opacity duration-500 group-hover:opacity-80">
              <h3 className="text-[6.5vw] sm:text-3xl leading-none text-white tracking-widest drop-shadow-[0_4px_12px_rgba(0,0,0,0.85)] transition-colors font-grift font-bold" style={{ fontFamily: "'Grift', sans-serif", fontWeight: 700 }}>
                {D.title}
              </h3>
