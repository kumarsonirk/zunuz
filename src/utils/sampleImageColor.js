...
// that second fetch is what used to sample colors, and being a separate
// network request it can resolve well after the visible photo itself has
// already appeared, racing any fallback that assumes a slow/blocked sample.
// The visible photo is already decoded in memory, so this is synchronous and
// available at the exact moment the photo becomes visible.
